                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        @if(auth()->user()->role === 'admin')
                            ...
                            <x-nav-link :href="route('admin.cuti.index')" :active="request()->routeIs('admin.cuti.index')">
                                {{ __('Pengajuan Cuti') }}
                            </x-nav-link>
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                @if(auth()->user()->role === 'admin')
                    ...
                    <x-responsive-nav-link :href="route('admin.cuti.index')" :active="request()->routeIs('admin.cuti.index')">
                        {{ __('Pengajuan Cuti') }}
                    </x-responsive-nav-link>
                @elseif(auth()->user()->role === 'karyawan')
